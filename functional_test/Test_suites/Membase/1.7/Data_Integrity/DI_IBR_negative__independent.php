...
abstract class DI_Negative_IBR_TestCase extends Zstore_TestCase {
	...
	public function test_DI_master_restore_negative() {
		...
		sleep(5);	// need delay to populate membase.log file
	...
	public function test_DI_negative_replication() {
		...
		membase_setup::restart_membase_servers(TEST_HOST_1);
...
/*
	public function test_merge_backups_without_checksum(){
		...
		membase_backup_setup::start_backup_daemon_full(TEST_HOST_2);
		$i=0;			$log_out = backup_tools_functions::poll_membase_backup_log_file();
