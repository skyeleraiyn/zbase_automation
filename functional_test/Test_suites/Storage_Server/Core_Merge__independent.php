...
abstract class IBR_CoreMerge_TestCase extends ZStore_TestCase {
	...
	public function test_One_Incremental() {
		...
		$this->assertTrue(backup_tools_functions::verify_membase_backup_upload(), "Uploading backups failed");		
		...
		$count_merge = membase_function::sqlite_cpoint_count(STORAGE_SERVER_1, TEMP_OUTPUT_FILE_0);
	...
	public function test_Three_Incr() {
		...
		membase_backup_setup::start_backup_daemon(TEST_HOST_2);
		$this->assertTrue(backup_tools_functions::verify_membase_backup_upload());	
	...
	public function est_Two_Backups_Single_Chkpoint() { // need to be investigated gets stuck
		...
		$chk_point_merge = membase_function::sqlite_chkpoint_count(STORAGE_SERVER_1, TEMP_OUTPUT_FILE_0);
