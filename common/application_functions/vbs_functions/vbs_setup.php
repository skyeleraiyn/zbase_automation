...
class vbs_setup	{
	...
	public function populate_and_copy_config_file($vbuckets = NO_OF_VBUCKETS)	{
		...
		$command_to_be_executed = "python26 ".HOME_DIRECTORY."common/misc_files/1.9_files/Config_Generate.py ".$array_string." ".$vbuckets." ".NO_OF_REPLICAS;
